...
Gem::Specification.new do |spec|
  spec.name          = 'indexer'
  spec.version       = Indexer::VERSION
  spec.authors       = ['Ontohub Core Developers']
  spec.email         = ['ontohub-dev-l@ovgu.de']

  spec.summary       = 'Indexes data for quick searching'
  spec.description   = 'Indexes data for quick searching'
  spec.homepage      = 'https://github.com/ontohub/indexer'
